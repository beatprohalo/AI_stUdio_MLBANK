      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="p-2 border-2 border-surface-border bg-input-bg text-on-surface rounded-md focus:ring-2 focus:ring-primary focus:border-primary transition disabled:opacity-50"
          >
